...
<html lang="en">
  <head>
    ...
    <script src="public/jquery/js/jquery-3.6.0.min.js"></script>
    <script src="public/pingfest/js/static/pingfest-theme.js"></script>
    <script src="public/pingfest/js/header.min.js"></script>
    <script src="public/popper/js/popper.min.js"></script>
    <script src="public/bootstrap/js/bootstrap.min.js"></script>

    <link rel="stylesheet" href="public/fontawesome/css/all.min.css" />
    <link rel="stylesheet" href="public/pingfest/css/header.min.css" />

    <link href="public/pingfest/img/ping.png" rel="icon" />
    <link href="public/pingfest/img/ping.png" rel="apple-touch-icon" />
    ...
    <link rel="stylesheet" href="public/pingfest/css/home.min.css" />
    <script src="public/pingfest/js/blob.min.js"></script>
    <script src="public/pingfest/js/home.min.js"></script>
    <link rel="stylesheet" href="public/pingfest/css/footer.min.css" />
    <link rel="stylesheet" href="assets/plugins/fontawesome-free/css/all.css" />
    <link rel="stylesheet" href="public/pingfest/css/sponsorlogo.min.css" />
  </head>
    ...
    <div style="display: flex; flex-direction: column; min-height: 100vh">
      <div style="flex: 1 0 auto">
        <header class="site-header sticky">
          ...
          <ul>
            <li>
              <a href="<?php echo site_url(); ?>" class="header-nav-link">
                Home</a
              >
            </li>
            <li>
              <a href="<?php echo site_url('itv" class="header-nav-link">
                IT-Venture</a
              >
            </li>
            <li>
              <a href="<?php echo site_url('semnas" class="header-nav-link">
                Semnas</a
              >
            </li>
            <li>
